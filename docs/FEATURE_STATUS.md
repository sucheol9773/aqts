...
| rebalancing | 리밸런싱 (정기·긴급·방어) | Tested | core/portfolio_manager/rebalancing.py | test_rebalancing.py (43) | 3가지 리밸런싱 모드 |
...
```
Total Tests: 3,934 tests (413 smoke-marked) — ALL PASS, Coverage 90%
