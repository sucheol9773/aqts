...
- 팀 3 권장 MCP (OPS-024 §4): `github` — RBAC 변경 PR 리뷰 필수 경로
...
- **Note**: `aqts-mcp-<본인이름>` (예: `aqts-mcp-team3`)
...
본 inbox 에 응답 메시지를 만들 때 `scripts/team/mailbox_new.sh 3 lead pat-setup-done` 으로 새 메일 생성 후 "설정 완료" 한 줄만 기록하세요.
