...
- 팀 1 권장 MCP (OPS-024 §4): `github` — 백테스트 리포트 PR 생성·리뷰
...
```bash
cd /Users/ahnsucheol/Desktop/aqts-team1-strategy
claude
...
본 inbox 에 응답 메시지를 만들 때 `scripts/team/mailbox_new.sh 1 lead pat-setup-done` 으로 새 메일 생성 후 "설정 완료" 한 줄만 기록하세요.
